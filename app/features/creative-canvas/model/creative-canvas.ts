...
const generationBlockDefinitions = {
  text: {
    ...
    status: "READY",
    contracts: [
      { label: "Brief", value: "Campaign brief", state: "READY" },
      { label: "Setup", value: "Draft structure", state: "OPTIONAL" },
      { label: "Creative Output", value: "Hooks and caption variants", state: "READY" },
    ],
  },
  llm: {
    kind: "llm",
    title: "Prompt",
    subtitle: "structured creative draft",
    description: "Shapes prompt variables into reusable campaign draft structure.",
    tone: "ink",
    status: "READY",
    contracts: [
      { label: "Brief", value: "Prompt variables", state: "READY" },
      { label: "Setup", value: "Draft structure", state: "OPTIONAL" },
      { label: "Creative Output", value: "Campaign draft", state: "READY" },
    ],
  },
  image: {
    kind: "image",
    ...
    status: "READY",
    contracts: [
      { label: "Brief", value: "Prompt and references", state: "READY" },
  ...
  video: {
    ...
    status: "NEEDS INPUT",
    contracts: [
      { label: "Brief", value: "Prompt, frame, or image", state: "OPTIONAL" },
  ...
  voice: {
    ...
    status: "DRAFT",
    contracts: [
      { label: "Brief", value: "Script or caption", state: "READY" },
      { label: "Setup", value: "Voice direction", state: "OPTIONAL" },
      { label: "Creative Output", value: "Voice takes", state: "WAITING" },
    ],
  },
  agent: {
    kind: "agent",
    ...
    status: "DRAFT",
    contracts: [
      { label: "Brief", value: "Campaign state and instruction", state: "READY" },
      { label: "Action", value: "Approved campaign steps", state: "OPTIONAL" },
      { label: "Creative Output", value: "Canvas updates", state: "WAITING" },
    ],
  },
  dm: {
    kind: "dm",
    ...
    status: "DRAFT",
    contracts: [
      { label: "Brief", value: "Comment trigger", state: "READY" },
      { label: "Action", value: "Reply path", state: "OPTIONAL" },
      { label: "Creative Output", value: "Tracked DM reply", state: "WAITING" },
    ],
  },
  landing: {
    kind: "landing",
    ...
    status: "DRAFT",
    contracts: [
      { label: "Brief", value: "Visitor and offer context", state: "READY" },
      { label: "Setup", value: "Landing content", state: "OPTIONAL" },
      { label: "Action", value: "Conversion event", state: "WAITING" },
    ],
  },
  custom: {
    kind: "custom",
    ...
    description: "Adds a creative action to the campaign canvas.",
    tone: "ink",
    status: "DRAFT",
    contracts: [
      { label: "Brief", value: "Creative input", state: "OPTIONAL" },
      { label: "Setup", value: "Plugin action", state: "OPTIONAL" },
      { label: "Creative Output", value: "Creative output", state: "WAITING" },
    ],
  },
